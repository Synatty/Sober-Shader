...
ColorCorrection.TintColor = Color3.fromRGB(255, 255, 189)
...
if ScriptName == "Sober Shaders" and script.Parent == ServerScriptService and script.RunContext then
